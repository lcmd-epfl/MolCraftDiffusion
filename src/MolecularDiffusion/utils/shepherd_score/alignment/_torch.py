...
from MolecularDiffusion.utils.shepherd_score.generate_point_cloud import _get_points_fibonacci
from MolecularDiffusion.utils.shepherd_score.score.gaussian_overlap import get_overlap, get_linear_hard_sphere_overlap
from MolecularDiffusion.utils.shepherd_score.score.gaussian_overlap import VAB_2nd_order
from MolecularDiffusion.utils.shepherd_score.score.electrostatic_scoring import get_overlap_esp, esp_combo_score
from MolecularDiffusion.utils.shepherd_score.score.electrostatic_scoring import VAB_2nd_order_esp
from MolecularDiffusion.utils.shepherd_score.score.pharmacophore_scoring import get_overlap_pharm, _SIM_TYPE
from MolecularDiffusion.utils.shepherd_score.alignment.utils.se3 import get_SE3_transform, apply_SE3_transform, quaternions_to_rotation_matrix, apply_SO3_transform
from MolecularDiffusion.utils.shepherd_score.alignment.utils.pca_np import quaternions_for_principal_component_alignment_np
from MolecularDiffusion.utils.shepherd_score.alignment.utils.pca import angle_between_vecs, rotation_axis, quaternion_from_axis_angle
...
def optimize_pharm_overlay(ref_pharms: torch.Tensor,
    ...
    if not extended_points:
        from MolecularDiffusion.utils.shepherd_score.score.analytical_gradients import compute_self_overlaps_pharm
        with torch.no_grad():
